...
export class CreateSemesterDto {
    @ApiProperty({
        description: '타입 (osaka_review: 오사카 후기 - 누구나 작성 가능, semester_info: 현지학기제 소개 - admin만)',
        enum: ['osaka_review', 'semester_info'],
        example: 'osaka_review'
    })
    @IsString()
    @IsIn(['osaka_review', 'semester_info'])  // 이 두 값만 허용
    type: 'osaka_review' | 'semester_info';
